...
Radarové „prší / čeká se déšť" už nejsou samostatné binárky — vše je v jedné
entitě `sensor …_dest` (viz sensor.py, ChmuRainSensor).
"""
...
async def async_setup_entry(
    ...
    async_add_entities([ChmuAlertsBinarySensor(runtime.coordinator, entry.entry_id)])
